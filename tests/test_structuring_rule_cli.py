"""Tests for structuring rule CLI."""
...
SCRIPT = ROOT / "scripts" / "run_structuring_rule.py"


def test_structuring_rule_cli_exists() -> None:
    assert SCRIPT.is_file()


def test_structuring_rule_cli_help_exits_zero() -> None:
    result = run(
...
def test_cli_run_help_includes_expected_options() -> None:
    ...
    assert "--min-transaction-count" in result.stdout
